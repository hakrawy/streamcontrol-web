...
export default function AdminDashboard() {
  ...
  const stats: StatCard[] = analytics ? [
    ...
    { label: 'Adult Titles', value: analytics.totalAdultContent || 0, icon: 'shield', color: '#C084FC' },
  ...
  const menuItems = [
    ...
    { label: 'Manage +18 Content', icon: 'shield', route: '/admin/adult', color: '#C084FC', count: analytics?.totalAdultContent || 0 },
    { label: 'Manage Channels', icon: 'live-tv', route: '/admin/channels', color: theme.error, count: analytics?.totalChannels },
    { label: 'TMDB Imports', icon: 'cloud-download', route: '/admin/imports', color: '#38BDF8' },
