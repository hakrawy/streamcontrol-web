...
const styles = StyleSheet.create({
  ...
  topBar: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: theme.spacing.md, paddingTop: theme.spacing.xs, gap: theme.spacing.sm, zIndex: 1500, elevation: 16 },
  backButton: {
    width: 44,
    height: 44,
    borderRadius: 22,
